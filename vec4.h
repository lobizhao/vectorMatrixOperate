...
public:
    ...
    vec4(const vec4
             &v2); // copy constructor, sets each element of this->data to v2's corresponding data
...
vec4 cross(const vec4 &v1,
           const vec4 &v2); //Compute the result of v1 x v2 using only their X, Y, and Z elements.
